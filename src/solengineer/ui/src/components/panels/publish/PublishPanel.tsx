...
// import { publishMessage, getHistory, clearHistory } from "../../../api/index";
// import { HistoryItem } from "../../../types/index";
// import { IconSend, IconClear, IconReplay } from "../../common/Icons";
...
import { useState, useEffect } from "react";
import { publishMessage, getHistory, clearHistory } from "../../../api";
    ...
    <div className={styles.page}>
      <div className={styles.topbar}>
        <div className={styles.topbarLeft}>
          <span className={styles.pageTitle}>Publish Message</span>
          <span className={styles.tagBlue}>Direct</span>
        </div>
        <div className={styles.topbarRight}>
          {publishCount > 0 && (
            <span className={styles.tagGreen}>✓ {publishCount} published</span>
          )}
          {status === "err" && (
            <span className={styles.tagRed}>✗ Publish failed</span>
          )}
        </div>
      </div>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.historyHeader}>
          <span className={styles.label}>History & Replay</span>
          {history.length > 0 && (
                ...
                <div key={i} className={styles.historyItem}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div className={styles.historyTop}>
                      <span className={styles.topicPill}>{h.topic}</span>
                  ...
                  <button className={styles.replayBtn} onClick={() => replay(h)}>
                    <IconReplay color="#1a73e8" />
                  </button>
                </div>
              ))}
