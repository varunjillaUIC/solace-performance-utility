...
// import { IconClear, IconStop, IconSubscribe } from "../../common/Icons";
    ...
    <div className={styles.page}>
      <div className={styles.topbar}>
        <div className={styles.topbarLeft}>
          <span className={styles.pageTitle}>Subscribe to Topic</span>
          {connected && <span className={styles.tagGreen}>● Live</span>}
        </div>
      ...
      <div className={styles.body}>
        <div className={styles.controlRow}>
          ...
          {!connected
            ? (
              <button className={styles.btnPrimary} onClick={() => onStart(topic)}>
                <IconSubscribe color="#fff" size={13} /> Subscribe
              </button>
            ) : (
            ...
            : messages.map((m) => (
              <div key={m.id} className={styles.msgCard}>
                <div className={styles.msgHeader}>
                  <span className={styles.topicPill}>{m.topic}</span>
