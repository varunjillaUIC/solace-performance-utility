...
export function IconChart({ size = 15, color }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 15 15" fill="none">
      <rect x="1" y="9" width="3" height="5" rx="1" fill={c(color)} opacity="0.6"/>
      <rect x="6" y="5" width="3" height="9" rx="1" fill={c(color)} opacity="0.8"/>
      <rect x="11" y="2" width="3" height="12" rx="1" fill={c(color)}/>
    </svg>
  );
}